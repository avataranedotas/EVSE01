...
void setup()
{
  ...
  t[2].pt = 2000;   //preset time   100
  t[3].pt = 500;   //erro diodo
  t[4].pt = 1000;   //preset time
...
void loop()
{
  ...
  if (millis() - timer4 > 100)
  {
    ...
    */
    ...
    //Entrar no Estado B
    if ((leitura_piloto_max3 > MIN_PWM_B) & (leitura_piloto_max3 < MIN_PWM_A) && (estado!=1) && (estado!=11))
    {
      t[1].in = true;
  ...
  */
    ...
    if ((estado==11) && (t[19].q)) auxpwm = float(amperes) / 0.6;
