...
void setup()
{
  ...
  t[1].pt = 2000;    //preset time  50
  t[2].pt = 2000;   //preset time   100
  t[3].pt = 500000;   //erro diodo
  t[4].pt = 500;   //preset time 500
  ...
  t[13].pt = 100000;  //timer entrada pwm diodo
  t[14].pt = 100000;  //timer entrada pwm diodo 100
...
void loop()
{
  ...
  */
    ...
    if (millis() - timer2 > 20)
    {
      ...
      display.drawString(4, 24, String(auxpwm));
